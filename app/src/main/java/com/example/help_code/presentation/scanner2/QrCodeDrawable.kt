 ...
 */
class QrCodeDrawable(qrCodeEntity: QrCodeEntity) : Drawable() {
    ...
    private val qrCodeViewModel = qrCodeEntity
    private val contentPadding = 25
    private var textWidth = contentTextPaint.measureText(qrCodeEntity.qrContent).toInt()
